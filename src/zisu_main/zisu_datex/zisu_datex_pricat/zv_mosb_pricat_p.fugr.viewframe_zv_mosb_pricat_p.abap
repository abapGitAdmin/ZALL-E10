*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_MOSB_PRICAT_P
*   generation date: 03.01.2018 at 11:07:30
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_MOSB_PRICAT_P    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_P'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_MOSB_PRICAT_P_EXTRACT
TOTAL = ZV_MOSB_PRICAT_P_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_P'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_MOSB_PRICAT_P-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MOSB_PRICAT_P_EXTRACT
TOTAL = ZV_MOSB_PRICAT_P_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_MOSB_PRICAT_P-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_P'
...
TOTAL = ZV_MOSB_PRICAT_P_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_MOSB_PRICAT_P-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_MOSB_PRICAT_P-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_P'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_MOSB_PRICAT_P-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MOSB_PRICAT_P_EXTRACT
TOTAL = ZV_MOSB_PRICAT_P_TOTAL
