*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_PRICAT_ITEM
*   generation date: 18.04.2019 at 09:24:55
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_PRICAT_ITEM      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_PRICAT_ITEM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_PRICAT_ITEM_EXTRACT
TOTAL = ZV_PRICAT_ITEM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_PRICAT_ITEM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_PRICAT_ITEM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_PRICAT_ITEM_EXTRACT
TOTAL = ZV_PRICAT_ITEM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_PRICAT_ITEM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_PRICAT_ITEM'
...
TOTAL = ZV_PRICAT_ITEM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_PRICAT_ITEM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_PRICAT_ITEM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_PRICAT_ITEM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_PRICAT_ITEM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_PRICAT_ITEM_EXTRACT
TOTAL = ZV_PRICAT_ITEM_TOTAL
