*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_MOSB_PRICAT_V
*   generation date: 03.01.2018 at 10:29:00
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_MOSB_PRICAT_V    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_MOSB_PRICAT_V_EXTRACT
TOTAL = ZV_MOSB_PRICAT_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_MOSB_PRICAT_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MOSB_PRICAT_V_EXTRACT
TOTAL = ZV_MOSB_PRICAT_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_MOSB_PRICAT_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_V'
...
TOTAL = ZV_MOSB_PRICAT_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_MOSB_PRICAT_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_MOSB_PRICAT_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_MOSB_PRICAT_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_MOSB_PRICAT_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MOSB_PRICAT_V_EXTRACT
TOTAL = ZV_MOSB_PRICAT_V_TOTAL
