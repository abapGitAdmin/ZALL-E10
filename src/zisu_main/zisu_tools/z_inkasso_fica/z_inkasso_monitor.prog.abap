...
* Positionstabelle
DATA: pos_itab_marked TYPE TABLE OF zinkasso_out WITH HEADER LINE,
...
DATA: wa_tout TYPE  zinkasso_out.
DATA: ft_out TYPE TABLE OF zinkasso_out.
DATA: t_out  TYPE TABLE OF zinkasso_out.

DATA: wa_opt TYPE zinkasso_opt.

DATA:  error           TYPE i.
DATA:  okcode          LIKE sy-ucomm.

DATA: t_gpvk TYPE TABLE OF zinkasso_select.
DATA: t_select TYPE TABLE OF zinkasso_select.
...
START-OF-SELECTION.
  ...
  LOOP AT t_tasks ASSIGNING <t_tasks>.
    ...
    CALL FUNCTION 'Z_INKASSO_SELECT'
...
FORM freigabe .
  ...
  DATA: itab_release  LIKE TABLE OF fkkop WITH HEADER LINE,
        ...
        ht_pos       TYPE zinkasso_out OCCURS 0 WITH HEADER LINE,
