...
CLASS lcl_checks DEFINITION FINAL CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA pa TYPE REF TO /adz/sci_test_scan.

    CLASS-METHODS get_instance
      IMPORTING p_parent   TYPE REF TO /adz/sci_test_scan
...
ENDCLASS.
CLASS /adz/sci_test_scan DEFINITION LOCAL FRIENDS lcl_checks.
