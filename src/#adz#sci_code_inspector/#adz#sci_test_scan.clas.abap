class /ADZ/SCI_TEST_SCAN definition
  public
  inheriting from CL_CI_TEST_SCAN
  create public .

*"* public components of class /ADZ/SCI_TEST_SCAN
*"* do not include other source files here!!!
*"* protected components of class /ADZ/SCI_TEST_SCAN
*"* do not include other source files here!!!
public section.
...
protected section.
  ...
  methods INFORM_ENHO
    importing
      ...
      !P_CHECKSUM_1 type INT4 optional
      !P_COMMENTS type T_COMMENTS optional .
*"* private components of class /ADZ/SCI_TEST_SCAN
*"* do not include other source files here!!!
private section.
  ...
  constants C_MY_NAME type SEOCLSNAME value '/ADZ/SCI_TEST_SCAN' ##NO_TEXT.
  constants:
...
CLASS /ADZ/SCI_TEST_SCAN IMPLEMENTATION.
...
*    add_obj_type( c_type_program ).
  ...
  METHOD GET_RESULT_NODE.
    ...
    IF object_type = 'ENHO'.
      ...
      CREATE OBJECT p_result TYPE /adz/sci_result_scan
        EXPORTING
          p_kind = ''.
    ELSE.
