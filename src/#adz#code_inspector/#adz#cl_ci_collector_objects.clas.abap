class /ADZ/CL_CI_COLLECTOR_OBJECTS definition
  public
...
*"* public components of class /ADZ/CL_CI_COLLECTOR_OBJECTS
...
CLASS /ADZ/CL_CI_COLLECTOR_OBJECTS IMPLEMENTATION.
  ...
  METHOD if_ci_collector~collect.
    DATA:
      ...
      lt_objects      TYPE TABLE OF /adz/sciobj,
    ...
    FIELD-SYMBOLS: <ls_object> TYPE /adz/sciobj.
...
*        cl_ci_objectset=>mark_object( changing p_object = l_object ).
    ...
    ELSE.
      ...
      ENDLOOP.
      DELETE FROM /adz/sciobj.
      INSERT /adz/sciobj FROM TABLE lt_objects.
      IF sy-subrc <> 0.
