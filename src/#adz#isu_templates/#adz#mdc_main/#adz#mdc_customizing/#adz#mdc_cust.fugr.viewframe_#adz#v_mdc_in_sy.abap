*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADZ/V_MDC_IN_SY
*   generation date: 20.11.2019 at 09:07:10
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADZ/V_MDC_IN_SY    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN_SY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADZ/V_MDC_IN_SY_EXTRACT
TOTAL = /ADZ/V_MDC_IN_SY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN_SY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADZ/V_MDC_IN_SY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_MDC_IN_SY_EXTRACT
TOTAL = /ADZ/V_MDC_IN_SY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADZ/V_MDC_IN_SY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN_SY'
...
TOTAL = /ADZ/V_MDC_IN_SY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADZ/V_MDC_IN_SY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADZ/V_MDC_IN_SY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN_SY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADZ/V_MDC_IN_SY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_MDC_IN_SY_EXTRACT
TOTAL = /ADZ/V_MDC_IN_SY_TOTAL
