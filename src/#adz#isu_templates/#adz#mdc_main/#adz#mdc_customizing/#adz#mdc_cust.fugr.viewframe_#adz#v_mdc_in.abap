*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADZ/V_MDC_IN
*   generation date: 18.11.2019 at 15:30:40
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADZ/V_MDC_IN       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADZ/V_MDC_IN_EXTRACT
TOTAL = /ADZ/V_MDC_IN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADZ/V_MDC_IN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_MDC_IN_EXTRACT
TOTAL = /ADZ/V_MDC_IN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADZ/V_MDC_IN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADZ/V_MDC_IN'
...
TOTAL = /ADZ/V_MDC_IN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADZ/V_MDC_IN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADZ/V_MDC_IN-UPD_FLAG NE SPACE.
