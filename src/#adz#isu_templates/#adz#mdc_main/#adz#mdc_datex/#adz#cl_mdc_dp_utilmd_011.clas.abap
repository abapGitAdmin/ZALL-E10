class /ADZ/CL_MDC_DP_UTILMD_011 definition
  public
  inheriting from /IDEXGE/CL_DP_UTILMD_011
  create public .
...
CLASS /ADZ/CL_MDC_DP_UTILMD_011 IMPLEMENTATION.
...
***************************************************************************************************
    IF siv_data_processing_mode = /idxgc/if_constants_add=>gc_data_from_add_source AND
      ...
      LOOP AT sis_process_data_src_add-/idxgl/profile_data ASSIGNING FIELD-SYMBOL(<ls_profile_data_src_add>)
        WHERE item_id = siv_itemid AND data_type_qual = /idxgl/if_constants_ide=>gc_seq_action_code_z17.
