*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADZ/V_BDR_DEVCO
*   generation date: 13.11.2019 at 19:49:35
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADZ/V_BDR_DEVCO    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADZ/V_BDR_DEVCO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADZ/V_BDR_DEVCO_EXTRACT
TOTAL = /ADZ/V_BDR_DEVCO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_BDR_DEVCO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADZ/V_BDR_DEVCO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_BDR_DEVCO_EXTRACT
TOTAL = /ADZ/V_BDR_DEVCO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADZ/V_BDR_DEVCO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADZ/V_BDR_DEVCO'
...
TOTAL = /ADZ/V_BDR_DEVCO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADZ/V_BDR_DEVCO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADZ/V_BDR_DEVCO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_BDR_DEVCO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADZ/V_BDR_DEVCO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_BDR_DEVCO_EXTRACT
TOTAL = /ADZ/V_BDR_DEVCO_TOTAL
