class /ADZ/CL_BDR_PARS_IDOCM_ORDE_01 definition
  public
  inheriting from /IDXGL/CL_PARS_IDOCMAP_ORDE_01
  final
  create public .
...
CLASS /ADZ/CL_BDR_PARS_IDOCM_ORDE_01 IMPLEMENTATION.
...
* ADZ Prozesse für Änderung Bilanzierungsverfahren / Gerätekonfiguration und Reklamation von Werten
    IF ls_segm_rff-reference_identifier = /adz/if_bdr_co=>gc_amid_17111 OR
       ls_segm_rff-reference_identifier = /adz/if_bdr_co=>gc_amid_17112 OR
       ls_segm_rff-reference_identifier = /adz/if_bdr_co=>gc_amid_17113.
      mv_dexbasicproc = /idxgc/if_constants_ide=>gc_basicproc_i_orders. "I_ORDERS
    ELSE.
      RETURN.
    ENDIF.
  ENDIF.
