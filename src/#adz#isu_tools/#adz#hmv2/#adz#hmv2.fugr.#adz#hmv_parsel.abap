...
* <<< ET_20160311
  DATA: rng_msgt_tab TYPE /adz/hmv_rt_msgt,
        so_date      TYPE /adz/cl_hmv_customizing=>ty_ab_bis.

  so_date-sign   = 'I'.
  so_date-option = 'EQ'.
  so_date-low    = ms_constants-c_faedn_from.
  so_date-high   = sy-datum.

  rng_msgt_tab = /adz/cl_hmv_customizing=>get_message_type( is_so_datum = so_date ).
