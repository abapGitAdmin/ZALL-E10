...
TYPES: tty_rng_bcln TYPE RANGE OF dfkkthi-bcbln.
...
* MEMIDOC
DATA:
  t_memidoc    TYPE TABLE OF /adz/hmv_selct_memi,
  t_memidoc2   TYPE TABLE OF /adz/hmv_selct_memi,
  t_selct_memi TYPE TABLE OF /adz/hmv_selct_memi.

*** --> Nuss 09.2018
* MSBDOC
DATA: t_msbdoc    TYPE TABLE OF /adz/hmv_selct_msb,
      t_msbdoc2   TYPE TABLE OF /adz/hmv_selct_msb,
      t_selct_msb TYPE TABLE OF /adz/hmv_selct_msb.
** <-- Nuss 09.2018
...
TYPES: tsy_fkkvkp LIKE t_fkkvkp.
TYPES: tty_fkkvkp type TABLE OF tsy_fkkvkp.
...
DATA:
  BEGIN OF wa_fkkop,                      "Geschäftspartnerpositionen zum Kontokorrentbeleg
    ...
    zz_idocin  TYPE /adz/hmv_idocin,
    zz_statin  TYPE /adz/hmv_statin,
    zz_idocct  TYPE /adz/hmv_idocct,
    zz_statct  TYPE /adz/hmv_statct,
    intui      TYPE int_ui,
...
* DFKKOP
DATA:
  wa_bcbln TYPE           /adz/hmv_selct,
  t_bcbln  TYPE TABLE OF  /adz/hmv_selct,
  t_tbcbl  TYPE TABLE OF  /adz/hmv_selct,
  t_selct  TYPE TABLE OF  /adz/hmv_selct.

FIELD-SYMBOLS: <t_bcbln>      TYPE /adz/hmv_selct,
               <t_bcbln_memi> TYPE /adz/hmv_selct_memi. "MEMI
...
DATA:
  ...
  wa_tout TYPE          /adz/hmv_s_out_dunning,
  ft_out  TYPE TABLE OF /adz/hmv_s_out_dunning,
  t_out   TYPE TABLE OF /adz/hmv_s_out_dunning,
  s_out   LIKE LINE  OF ft_out.

FIELD-SYMBOLS: <t_out> TYPE /adz/hmv_s_out_dunning.
...
*DATA:
*  t_hmv_const TYPE /adz/hmv_t_constants WITH HEADER LINE,
*  s_hmv_const TYPE /adz/hmv_s_constants.

DATA:
  t_hmv_ival TYPE TABLE OF /adz/hmv_ival WITH HEADER LINE,
  s_hmv_ival TYPE          /adz/hmv_ival,
  s_interval TYPE          /adz/hmv_ival.

* --> Nuss 05.03.2018
DATA: t_hmv_mver TYPE TABLE OF /adz/hmv_mver WITH HEADER LINE,
      s_hmv_mver TYPE          /adz/hmv_mver.
* <-- Nuss 05.03.2018
...
" Performance Buffer
DATA gt_dfkkop_buffer type tty_dfkkop_buffer.
