FUNCTION /ADZ/HMV_SELECT_MSBDOC.
*"----------------------------------------------------------------------
...
*"  TABLES
*"      IT_SELCT_MSB STRUCTURE  /ADZ/HMV_SELCT_MSB
...
** IDOC-Status-Ermittlung
    ...
    SELECT SINGLE * FROM /adz/hmv_mosb INTO ls_hmv_msb WHERE invdocno = <t_fkkop_msb>-opbel.
