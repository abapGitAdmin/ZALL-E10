*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADESSO/V_BPM_RU
*   generation date: 15.09.2015 at 14:12:00
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADESSO/V_BPM_RU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_RU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADESSO/V_BPM_RU_EXTRACT
TOTAL = /ADESSO/V_BPM_RU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_RU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADESSO/V_BPM_RU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_BPM_RU_EXTRACT
TOTAL = /ADESSO/V_BPM_RU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADESSO/V_BPM_RU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_RU'
...
TOTAL = /ADESSO/V_BPM_RU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADESSO/V_BPM_RU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADESSO/V_BPM_RU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_RU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADESSO/V_BPM_RU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_BPM_RU_EXTRACT
TOTAL = /ADESSO/V_BPM_RU_TOTAL
