*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADESSO/V_BPM_GE
*   generation date: 09.09.2015 at 13:50:58
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADESSO/V_BPM_GE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_GE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADESSO/V_BPM_GE_EXTRACT
TOTAL = /ADESSO/V_BPM_GE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_GE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADESSO/V_BPM_GE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_BPM_GE_EXTRACT
TOTAL = /ADESSO/V_BPM_GE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADESSO/V_BPM_GE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_GE'
...
TOTAL = /ADESSO/V_BPM_GE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADESSO/V_BPM_GE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADESSO/V_BPM_GE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_BPM_GE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADESSO/V_BPM_GE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_BPM_GE_EXTRACT
TOTAL = /ADESSO/V_BPM_GE_TOTAL
