FUNCTION-POOL /ADESSO/INKASSO_FG_SWK.           "MESSAGE-ID ..

* INCLUDE /ADESSO/LINKASSO_FGD...            " Local class definition
...
DATA: gs_nfhf TYPE /adesso/nfhf,
      gt_nfhf TYPE STANDARD TABLE OF /adesso/nfhf.
