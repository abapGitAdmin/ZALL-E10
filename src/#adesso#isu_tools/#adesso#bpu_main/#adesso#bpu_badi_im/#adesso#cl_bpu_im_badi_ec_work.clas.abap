class /ADESSO/CL_BPU_IM_BADI_EC_WORK definition
  public
  create public .
    ...
    CASE iv_ucomm.
      WHEN '+EF1'.
        ...
        IF <fs_emma_ccat_sop> IS ASSIGNED.
          ...
          TRY.
              lt_emma_case = /adesso/cl_bpu_utility=>get_cases_by_param( it_casenr = lt_cases it_casestat = lt_case_stat ).
