FUNCTION /ADZ/FM_ZAEHLER_ID_SHLPS.
*"--------------------------------------------------------------------
  ...
  IF callcontrol-step = 'SELONE'.
    ...
    IF <fs_interface> IS ASSIGNED.
      LOOP AT shlp_tab INTO ls_shlp.
        IF ls_shlp-shlpname = '/ADZ/SH_ZAEHLER_ID_ELE' AND <fs_interface>-value = '02'.
          DELETE shlp_tab.
        ELSEIF ls_shlp-shlpname = '/ADZ/SH_ZAEHLER_ID_GAS' AND <fs_interface>-value = '01'.
          DELETE shlp_tab.
        ENDIF.
      ENDLOOP.
    ENDIF.
