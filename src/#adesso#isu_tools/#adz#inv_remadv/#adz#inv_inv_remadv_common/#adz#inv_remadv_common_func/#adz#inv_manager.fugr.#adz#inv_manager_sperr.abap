FUNCTION /ADZ/INV_MANAGER_SPERR .
*"--------------------------------------------------------------------
...
* MessageID
  ...
  DATA :ls_inv_sperr TYPE /adz/invsperr,
        val1         TYPE sy-msgv1.
...
* <y_process> and check it
  LOOP AT xy_process_data ASSIGNING <y_process>
    ...
    LOOP AT <y_process>-inv_doc ASSIGNING <doc>
      ...
      SELECT SINGLE * FROM /adz/invsperr INTO ls_inv_sperr WHERE int_inv_doc_nr =  <doc>-int_inv_doc_no.
