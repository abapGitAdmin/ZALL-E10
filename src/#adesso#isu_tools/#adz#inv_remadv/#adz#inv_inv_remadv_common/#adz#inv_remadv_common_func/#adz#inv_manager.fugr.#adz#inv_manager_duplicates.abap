FUNCTION /adz/inv_manager_duplicates .
*"--------------------------------------------------------------------
...
* Prüfung ob externe Rechnungsnummer gefüllt
      IF <doc>-ext_invoice_no IS INITIAL.
        msg_to_inv_return space co_msg_error '/ADZ/INV_MANAGER' '014' space space space space..
        IF 1 = 2.
          MESSAGE e014(/adz/inv_manager).
      ...
      IF sy-subrc = 0.
        LOOP AT t_doc.
          ...
          IF t_doc-inv_doc_status NE '08'.
            ...
            msg_to_inv_return space co_msg_error '/ADZ/INV_MANAGER' '015'
                                  t_doc-int_inv_doc_no t_doc-inv_bulk_ref t_doc-inv_doc_status space.
            IF 1 = 2.
              MESSAGE e015(/adz/inv_manager).
          ...
          ELSE.
            ...
            msg_to_inv_return space co_msg_warning '/ADZ/INV_MANAGER' '015'
                                  t_doc-int_inv_doc_no t_doc-inv_bulk_ref t_doc-inv_doc_status space.
            IF 1 = 2.
              MESSAGE w015(/adz/inv_manager).
              "RG mit int. BelNr ReNr &1 und ident. GrpRefNr &2 im Status &3 vorhanden
            ENDIF.
          ENDIF.
...
* Prüfung auf vorhandene Rechnungen mit identischer ext. Rechnungsnummer und abweichender DA-Gruppenreferenz
      ...
      IF sy-subrc = 0.
        LOOP AT t_doc2.
          ...
          IF t_doc2-inv_doc_status NE '08'.
            ...
            msg_to_inv_return space co_msg_error '/ADZ/INV_MANAGER' '016'
                                  t_doc2-int_inv_doc_no t_doc2-inv_bulk_ref t_doc2-inv_doc_status space.
            IF 1 = 2.
              MESSAGE e016(/adz/inv_manager).
          ...
          ELSE.
            ...
            msg_to_inv_return space co_msg_warning '/ADZ/INV_MANAGER' '016'
                                  t_doc2-int_inv_doc_no t_doc2-inv_bulk_ref t_doc2-inv_doc_status space.
            IF 1 = 2.
              MESSAGE w016(/adz/inv_manager).
              "RG mit int. BelNr ReNr &1 und abw. GrpRefNr &2 im Status &3 vorhanden
            ENDIF.
          ENDIF.
    ...
    IF  fehler_kz IS INITIAL.
      msg_to_inv_return space co_msg_success '/ADZ/INV_MANAGER' '017' space space space space.
      IF 1 = 2.
        MESSAGE s017(/adz/inv_manager).
        "Prüfung auf doppelte Rechnungseingänge erfolgreich.
      ENDIF.
    ELSEIF fehler_kz EQ 'F'.
      msg_to_inv_return space co_msg_error '/ADZ/INV_MANAGER' '018' space space space space.
      IF 1 = 2.
        MESSAGE e018(/adz/inv_manager).
        "Prüfung auf doppelte Rechnungseingänge nicht erfolgreich.
      ENDIF.
    ELSEIF fehler_kz EQ 'W'.
      msg_to_inv_return space co_msg_warning '/ADZ/INV_MANAGER' '019' space space space space.
      IF 1 = 2.
        MESSAGE w019(/adz/inv_manager).
