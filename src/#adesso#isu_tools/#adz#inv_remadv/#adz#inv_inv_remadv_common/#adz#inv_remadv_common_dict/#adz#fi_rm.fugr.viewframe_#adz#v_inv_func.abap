*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADZ/V_INV_FUNC
*   generation date: 08.01.2021 at 13:40:58
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADZ/V_INV_FUNC     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADZ/V_INV_FUNC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADZ/V_INV_FUNC_EXTRACT
TOTAL = /ADZ/V_INV_FUNC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_INV_FUNC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADZ/V_INV_FUNC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_INV_FUNC_EXTRACT
TOTAL = /ADZ/V_INV_FUNC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADZ/V_INV_FUNC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADZ/V_INV_FUNC'
...
TOTAL = /ADZ/V_INV_FUNC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADZ/V_INV_FUNC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADZ/V_INV_FUNC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADZ/V_INV_FUNC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADZ/V_INV_FUNC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADZ/V_INV_FUNC_EXTRACT
TOTAL = /ADZ/V_INV_FUNC_TOTAL
