...
*"--------------------------------------------------------------------
  ...
  DATA lt_memilock TYPE TABLE OF /adz/mem_mloc.
  DATA: gt_outtab  TYPE STANDARD TABLE OF /adz/mem_mloc,
        lv_columns TYPE i,
  ...
  SELECT * FROM /adz/mem_mloc INTO TABLE gt_outtab WHERE doc_id = doc_id.
