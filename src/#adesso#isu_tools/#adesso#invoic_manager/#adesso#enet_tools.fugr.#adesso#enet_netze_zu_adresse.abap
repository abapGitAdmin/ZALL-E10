FUNCTION /ADESSO/ENET_NETZE_ZU_ADRESSE.
*"--------------------------------------------------------------------
...
*"--------------------------------------------------------------------
  DATA: ls_adrc            TYPE adrc,
        ls_zadenet_plz_hnr TYPE /adesso/plz_hnr,
        ls_zadenet_plz_str TYPE /adesso/plz_str,
        ls_zadenet_plz_ot  TYPE /adesso/plz_ot,
        ls_zadenet_plz     TYPE /adesso/enet_plz.



  ls_adrc = adrc.
  "Netz auf hausnummernebene
  SELECT SINGLE * FROM /adesso/plz_hnr
  ...
  ELSE.
    ...
    SELECT SINGLE * FROM /adesso/plz_str
    ...
    ELSE.
      ...
      SELECT SINGLE * FROM /adesso/plz_ot
      ...
      IF sy-subrc = 0.
        ...
        SELECT SINGLE * FROM /adesso/enet_plz
          INTO ls_zadenet_plz
