        ...
        IF <fs_seltab> IS ASSIGNED AND <fs_seltab>-badi_name IS NOT INITIAL.
          TRY.
            ...
            CATCH cx_badi_not_implemented.
              MESSAGE i071(/adesso/mdc_process).
      ...
      ELSE.
        ...
        IF <fs_seltab> IS ASSIGNED AND <fs_seltab>-badi_name IS NOT INITIAL.
          TRY.
            ...
            CATCH cx_badi_not_implemented.
              MESSAGE i070(/adesso/mdc_process).
            CATCH /idxgc/cx_utility_error.
              MESSAGE ID sy-msgid TYPE 'I' NUMBER sy-msgno WITH sy-msgv1 sy-msgv2 sy-msgv3 sy-msgv4.
          ENDTRY.
          PERFORM reload_alv_grid.
...
***** Ablehnungsgrund 1 ***************************************************************************
    WHEN 'BTN5'.
      ...
      IF <fs_check_details>-rejection_code = /idxgc/if_constants_ide=>gc_respstatus_e13 .
        <fs_check_details>-proc_step_value = /adesso/if_mdc_co=>gc_cr_no_accept.
        APPEND INITIAL LINE TO gs_proc_step_data-proc_step_values ASSIGNING <fs_proc_step_values>.
        <fs_proc_step_values> = /adesso/if_mdc_co=>gc_cr_no_accept.
      ENDIF.
...
***** Ablehnungsgrund 2 ***************************************************************************
    WHEN 'BTN6'.
      ...
      IF <fs_check_details>-rejection_code = /idxgc/if_constants_ide=>gc_respstatus_ze2.
        <fs_check_details>-proc_step_value = /adesso/if_mdc_co=>gc_cr_no_accept.
        APPEND /adesso/if_mdc_co=>gc_cr_no_accept TO gs_proc_step_data-proc_step_values.
...
***** Zustimmen bzw. Daten senden *****************************************************************
    WHEN 'BTN7'.
      ...
      ELSEIF <fs_check_details>-rejection_code = /idxgc/if_constants_add=>gc_response_code_zg2.
        <fs_check_details>-proc_step_value = /adesso/if_mdc_co=>gc_cr_send_valid_data.
        APPEND /adesso/if_mdc_co=>gc_cr_send_valid_data TO gs_proc_step_data-proc_step_values.
      ENDIF.
