*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADESSO/V_MDC_PD
*   generation date: 12.10.2015 at 14:49:08
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADESSO/V_MDC_PD    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_PD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADESSO/V_MDC_PD_EXTRACT
TOTAL = /ADESSO/V_MDC_PD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_PD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADESSO/V_MDC_PD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_PD_EXTRACT
TOTAL = /ADESSO/V_MDC_PD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADESSO/V_MDC_PD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_PD'
...
TOTAL = /ADESSO/V_MDC_PD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADESSO/V_MDC_PD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADESSO/V_MDC_PD-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_PD'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADESSO/V_MDC_PD-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_PD_EXTRACT
TOTAL = /ADESSO/V_MDC_PD_TOTAL
