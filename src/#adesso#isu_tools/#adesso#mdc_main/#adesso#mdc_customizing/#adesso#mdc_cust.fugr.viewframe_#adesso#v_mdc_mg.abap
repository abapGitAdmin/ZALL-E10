*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADESSO/V_MDC_MG
*   generation date: 13.10.2015 at 09:32:27
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADESSO/V_MDC_MG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_MG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADESSO/V_MDC_MG_EXTRACT
TOTAL = /ADESSO/V_MDC_MG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_MG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADESSO/V_MDC_MG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_MG_EXTRACT
TOTAL = /ADESSO/V_MDC_MG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADESSO/V_MDC_MG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_MG'
...
TOTAL = /ADESSO/V_MDC_MG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADESSO/V_MDC_MG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADESSO/V_MDC_MG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_MG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADESSO/V_MDC_MG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_MG_EXTRACT
TOTAL = /ADESSO/V_MDC_MG_TOTAL
