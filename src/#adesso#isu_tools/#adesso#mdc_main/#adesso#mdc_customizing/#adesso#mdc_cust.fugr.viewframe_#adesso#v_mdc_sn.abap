*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/ADESSO/V_MDC_SN
*   generation date: 12.10.2015 at 16:00:27
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/ADESSO/V_MDC_SN    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_SN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /ADESSO/V_MDC_SN_EXTRACT
TOTAL = /ADESSO/V_MDC_SN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_SN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/ADESSO/V_MDC_SN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_SN_EXTRACT
TOTAL = /ADESSO/V_MDC_SN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/ADESSO/V_MDC_SN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_SN'
...
TOTAL = /ADESSO/V_MDC_SN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/ADESSO/V_MDC_SN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/ADESSO/V_MDC_SN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/ADESSO/V_MDC_SN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/ADESSO/V_MDC_SN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /ADESSO/V_MDC_SN_EXTRACT
TOTAL = /ADESSO/V_MDC_SN_TOTAL
