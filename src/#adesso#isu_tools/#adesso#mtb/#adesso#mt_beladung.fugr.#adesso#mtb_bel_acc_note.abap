FUNCTION /adesso/mtb_bel_acc_note.
*"----------------------------------------------------------------------
...
* werden müssen (siehe: case itrans-dttyp).
      IF itrans-oldkey NE oldkey_acn AND
            oldkey_acn NE space.

* Umschlüsselung-FUBA (aus Customizing Tabelle s.o.)
        IF NOT ums_fuba IS INITIAL.
*         CALL FUNCTION '/ADESSO/MTU_SAMPLE_BEL_ACC_NOTE'
...
*  Dateiaufbereitung zum erstellen der Workbench-Dateien
        PERFORM aufbereitung_dat_acn USING oldkey_acn
                                           rep_name
                                           form_name.
        anz_obj = anz_obj + 1.
...
* => je Datentyp eigene Tabelle
      CASE itrans-dttyp.
        WHEN 'NOTKEY'.
          CLEAR x_iacn_notkey.
          MOVE itrans-data TO x_iacn_notkey.
          MOVE-CORRESPONDING x_iacn_notkey TO iacn_notkey.
          APPEND iacn_notkey.
          CLEAR iacn_notkey.
        WHEN 'NOTLIN'.
          CLEAR x_iacn_notlin.
          MOVE itrans-data TO x_iacn_notlin.
          MOVE-CORRESPONDING x_iacn_notlin TO iacn_notlin.
          APPEND iacn_notlin.
          CLEAR iacn_notlin.
      ENDCASE.

      MOVE itrans-oldkey TO oldkey_acn.
...
* Erstellen der Migrationsdatei
  ...
  ELSE.
    PERFORM erst_mig_datei TABLES i_acn_down
                            USING firma
                                  object
                                  idttyp
                                  bel_file.
