FUNCTION /adesso/mtb_bel_bcontact.
*"----------------------------------------------------------------------
...
* werden müssen (siehe: case itrans-dttyp).
      IF itrans-oldkey NE oldkey_bct AND
            oldkey_bct NE space.

* Umschlüsselung-FUBA (aus Customizing Tabelle s.o.)
        IF NOT ums_fuba IS INITIAL.
*         CALL FUNCTION '/ADESSO/MTU_SAMPLE_BEL_BCONTACT'
...
*  Dateiaufbereitung zum erstellen der Workbench-Dateien
        PERFORM aufbereitung_dat_bct USING oldkey_bct
                                           rep_name
                                           form_name.
        anz_obj = anz_obj + 1.
...
* => je Datentyp eigene Tabelle
      CASE itrans-dttyp.
        WHEN 'BCONTD'.
          CLEAR x_ibct_bcontd.
          MOVE itrans-data TO x_ibct_bcontd.
          MOVE-CORRESPONDING x_ibct_bcontd TO ibct_bcontd.
          APPEND ibct_bcontd.
          CLEAR ibct_bcontd.
        WHEN 'PBCOBJ'.
          CLEAR x_ibct_pbcobj.
          MOVE itrans-data TO x_ibct_pbcobj.
          MOVE-CORRESPONDING x_ibct_pbcobj TO ibct_pbcobj.
          APPEND ibct_pbcobj.
          CLEAR ibct_pbcobj.
      ENDCASE.

      MOVE itrans-oldkey TO oldkey_bct.
...
* Erstellen der Migrationsdatei
  ...
  ELSE.
    PERFORM erst_mig_datei TABLES i_bct_down
                            USING firma
                                  object
                                  idttyp
                                  bel_file.
