...
* werden müssen (siehe: case itrans-dttyp).
      IF itrans-oldkey NE oldkey_lot AND
            oldkey_lot NE space.

* Umschlüsselung-FUBA (aus Customizing Tabelle s.o.)
        IF NOT ums_fuba IS INITIAL.
*         CALL FUNCTION '/ADESSO/MTU_SAMPLE_BEL_LOT'
          CALL FUNCTION ums_fuba
               ...
               TABLES
                    ...
                    ilot_lotd  = ilot_lotd
               CHANGING
                    oldkey_lot = oldkey_lot.
        ENDIF.


*  Dateiaufbereitung zum erstellen der Workbench-Dateien
        PERFORM aufbereitung_dat_lot USING oldkey_lot
                                           rep_name
                                           form_name.
        anz_obj = anz_obj + 1.
...
* => je Datentyp eigene Tabelle
      CASE itrans-dttyp.
        WHEN 'LOTD'.
          MOVE itrans-data TO ilot_lotd.
          APPEND ilot_lotd.
          CLEAR ilot_lotd.
      ENDCASE.

      MOVE itrans-oldkey TO oldkey_lot.
...
* Erstellen der Migrationsdatei
  ...
  ELSE.
    PERFORM erst_mig_datei TABLES i_lot_down
                            USING firma
                                  object
                                  idttyp
                                  bel_file.
