class ZCL_ZKERK_GELSENWASSER_MPC definition
  public
...
TT_KOPFDATEN type standard table of TS_KOPFDATEN .
  ...
  types:
     TS_POSITIONSDATEN type ZKERK_S_ZAPOSDAT_ODATA .
  types:
TT_POSITIONSDATEN type standard table of TS_POSITIONSDATEN .
  types:
     TS_NOTIZ type ZKERK_S_ZANOTIZ_ODATA .
  types:
TT_NOTIZ type standard table of TS_NOTIZ .
  types:
     TS_BUCHUNGSCODE type ZKERK_S_BUCHUNGDAT_ODATA .
  types:
TT_BUCHUNGSCODE type standard table of TS_BUCHUNGSCODE .

  constants GC_BUCHUNGSCODE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Buchungscode' ##NO_TEXT.
  constants GC_KOPFDATEN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Kopfdaten' ##NO_TEXT.
  constants GC_NOTIZ type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Notiz' ##NO_TEXT.
  constants GC_POSITIONSDATEN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Positionsdaten' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZKERK_GELSENWASSER_MPC====CP' ##NO_TEXT.

  methods DEFINE_KOPFDATEN
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_POSITIONSDATEN
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_NOTIZ
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BUCHUNGSCODE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZKERK_GELSENWASSER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZKERK_GELSENWASSER_SCHNITSTEL_SRV' ).

define_kopfdaten( ).
define_positionsdaten( ).
define_notiz( ).
define_buchungscode( ).
  endmethod.


  method DEFINE_BUCHUNGSCODE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Buchungscode' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'BuchungscodeId' iv_abap_fieldname = 'BUCHUNGSCODE_ID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZKERK_S_BUCHUNGDAT_ODATA'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BuchungscodeSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Notiz' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'NotizId' iv_abap_fieldname = 'NOTIZ_ID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 12 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZKERK_S_ZANOTIZ_ODATA'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'NotizSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - Positionsdaten
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Positionsdaten' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NummerPositionsdaten' iv_abap_fieldname = 'NUMMER_POSITIONSDATEN' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZKERK_S_ZAPOSDAT_ODATA'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PositionsdatenSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181126100507'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'NummerPositionsdaten'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Positionsdaten'.                            "#EC NOTEXT
