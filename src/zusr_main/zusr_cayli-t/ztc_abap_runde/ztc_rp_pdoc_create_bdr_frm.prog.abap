...
DATA itab TYPE TABLE OF screen-name.
DATA wa_itab LIKE LINE OF itab.

LOOP AT SCREEN.

IF screen-name = '%BBK3033_BLOCK_1000'.
  screen-active = 0.
...
FORM pf_radio_switch.
  ...
  LOOP AT SCREEN.
    IF screen-group1 = 'M30'.               "analysieren
      IF r34 = 'X'.
        screen-input = 0.
...
FORM pf_change_rad .
  ...
  IF r34 = 'X' AND ( mid_lbl IS INITIAL AND p_audate IS INITIAL AND p_bilver IS INITIAL ).
    MESSAGE ID 'ZTC_MSG' TYPE 'I' NUMBER '000' DISPLAY LIKE 'E'.
  ELSEIF r30 = 'X' AND imp_lbl IS INITIAL.
    MESSAGE ID 'ZTC_MSG' TYPE 'I' NUMBER '001' DISPLAY LIKE 'E'.
  ENDIF.
