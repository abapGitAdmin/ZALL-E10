*&---------------------------------------------------------------------*
*&  Include           ZTC_PERFORMANCE_MYPLANER_SEL
*&---------------------------------------------------------------------*
SELECTION-SCREEN BEGIN OF BLOCK gb_eins WITH FRAME TITLE TEXT-bk1.
  PARAMETERS:
  pr_aufg RADIOBUTTON GROUP gA DEFAULT 'X',
  pr_noti RADIOBUTTON GROUP gA.
SELECTION-SCREEN END OF BLOCK gb_eins.


SELECTION-SCREEN BEGIN OF BLOCK gb_hdr WITH FRAME TITLE TEXT-bk1.
PARAMETERS:
  p_aaaa TYPE e_dexservprovself MATCHCODE OBJECT serviceprovider OBLIGATORY MODIF ID bl1,
  p_bbb TYPE e_dexservprov OBLIGATORY MODIF ID bl1.
