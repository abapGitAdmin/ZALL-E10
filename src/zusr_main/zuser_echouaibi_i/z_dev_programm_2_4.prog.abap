...
* ----- Berechnung der MWST mittels Unterprogramm ----- *
  PERFORM enthaltene_mehrwertsteuer
  USING summe
  CHANGING mwst .
...
* ----- Unterprogramm MWST ----- *
FORM enthaltene_mehrwertsteuer USING brutto TYPE betrag
CHANGING mwst TYPE betrag .
  mwst = ( brutto * mwstsatz ) /
  ( mwstsatz + 100 ) .
ENDFORM.
