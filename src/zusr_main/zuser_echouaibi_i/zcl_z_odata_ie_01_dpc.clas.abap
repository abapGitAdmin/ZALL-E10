class ZCL_Z_ODATA_IE_01_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_ODATA_IE_01_MPC=>TS_HEADERDATA
    raising
  ...
  methods PRODUCTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_ODATA_IE_01_MPC=>TT_HEADERDATA
...
CLASS ZCL_Z_ODATA_IE_01_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 26.07.2019 11:46:01 in client 010
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_ODATA_IE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_z_odata_ie_01_mpc=>ts_headerdata.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_z_odata_ie_01_mpc=>ts_headerdata.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_ODATA_IE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_z_odata_ie_01_mpc=>tt_headerdata.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_z_odata_ie_01_mpc=>ts_headerdata.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
