class ZCL_Z_IE_PRODUCT_DEMO_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_IE_PRODUCT_DEMO_MPC=>TS_PRODUCT
    raising
  ...
  methods PRODUCTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_IE_PRODUCT_DEMO_MPC=>TT_PRODUCT
...
CLASS ZCL_Z_IE_PRODUCT_DEMO_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 16.07.2019 13:52:47 in client 010
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_IE_PRODUCT_DEMO_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_z_ie_product_demo_mpc=>ts_product.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_z_ie_product_demo_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_IE_PRODUCT_DEMO_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_z_ie_product_demo_mpc=>tt_product.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_z_ie_product_demo_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
