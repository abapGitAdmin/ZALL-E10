class ZHA_CL_SMO_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZHA_CL_SMO_AREA' ##NO_TEXT.
  data ROOT type ref to ZHA_CL_SMO_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZHA_CL_SMO_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZHA_CL_SMO_ROOT
    raising
...
CLASS ZHA_CL_SMO_AREA IMPLEMENTATION.
