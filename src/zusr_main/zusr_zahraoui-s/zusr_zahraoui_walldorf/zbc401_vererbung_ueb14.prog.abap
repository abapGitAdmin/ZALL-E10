...
*&
*&---------------------------------------------------------------------*
REPORT zbc401_vererbung_ueb14.

"CONSTANTS ca1.



INCLUDE MY_INTERFACE_14.
*INCLUDE my_interface_12.
*INCLUDE MY_INTERFACE.

INCLUDE Z_ALLE_KLASSE_14.
...
DATA:
      "üb14
      go_vehicle TYPE REF TO vehicle,
      go_rentAl TYPE REF TO rental,
  "9 nur carrier
...
START-OF-SELECTION.
 ...
 " üb14
  ...
  EXPORTING
    iv_name = 'mein gemetes auto'.
 "einfügen an der Liste vom Partner
