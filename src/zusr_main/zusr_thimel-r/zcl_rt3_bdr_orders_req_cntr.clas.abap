class ZCL_RT3_BDR_ORDERS_REQ_CNTR definition
  public
  create public .

*"* public components of class ZCL_RT3_BDR_ORDERS_REQ_CNTR
...
public section.
  ...
  methods PAI
    ...
    exceptions
      ERROR_OCCURRED .
protected section.
*"* protected components of class ZCL_RT3_BDR_ORDERS_REQ_CNTR
*"* do not include other source files here!!!
  ...
  methods ON_DOUBLE_CLICK
    ...
    importing
      ...
      !ES_ROW_NO .
private section.
*"* private components of class ZCL_RT3_BDR_ORDERS_REQ_CNTR
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_RT3_BDR_ORDERS_REQ_CNTR IMPLEMENTATION.
