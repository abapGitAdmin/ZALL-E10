class ZCL_ZSHW_GELSENWASSER_MPC definition
  public
...
public section.
  ...
  types:
     TS_KOPFDATEN type ZZSHW_S_PAORHEA_ODATA .
  types:
TT_KOPFDATEN type standard table of TS_KOPFDATEN .
  types:
  ...
  constants GC_KOPFDATEN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Kopfdaten' ##NO_TEXT.
...
CLASS ZCL_ZSHW_GELSENWASSER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSHW_GELSENWASSER_SRV' ).

define_kopfdaten( ).
  endmethod.


  method DEFINE_KOPFDATEN.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Kopfdaten' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Zantest' iv_abap_fieldname = 'ZANTEST' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Hausnummer' iv_abap_fieldname = 'HAUSNUMMER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZZSHW_S_PAORHEA_ODATA'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'KopfdatenSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181126100513'.                  "#EC NOTEXT
