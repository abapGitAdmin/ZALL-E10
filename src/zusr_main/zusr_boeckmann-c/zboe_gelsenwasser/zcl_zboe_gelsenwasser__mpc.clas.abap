class ZCL_ZBOE_GELSENWASSER__MPC definition
  public
...
public section.
  ...
  types:
     TS_ZBOE_KOPFDAT type ZBOE_KOPFDAT .
  types:
TT_ZBOE_KOPFDAT type standard table of TS_ZBOE_KOPFDAT .
  types:
  ...
  types:
     TS_ZBOE_BUCODE type ZBOE_BUCODE .
  types:
TT_ZBOE_BUCODE type standard table of TS_ZBOE_BUCODE .
  types:
     TS_ZBOE_POSDAT type ZBOE_POSDAT .
  types:
TT_ZBOE_POSDAT type standard table of TS_ZBOE_POSDAT .
  types:
     TS_ZBOE_NOTE type ZBOE_NOTE .
  types:
TT_ZBOE_NOTE type standard table of TS_ZBOE_NOTE .

  constants GC_ZBOE_BUCODE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZBOE_BUCODE' ##NO_TEXT.
  constants GC_ZBOE_KOPFDAT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZBOE_KOPFDAT' ##NO_TEXT.
  constants GC_ZBOE_NOTE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZBOE_NOTE' ##NO_TEXT.
  constants GC_ZBOE_POSDAT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZBOE_POSDAT' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_ZBOE_KOPFDAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZBOE_BUCODE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZBOE_POSDAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZBOE_NOTE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZBOE_GELSENWASSER__MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBOE_GELSENWASSER_ODATA_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZBOE_BUCODE' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'BucoId' iv_abap_fieldname = 'BUCO_ID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBOE_BUCODE'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZBOE_BUCODESet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZBOE_KOPFDAT' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AsrComment' iv_abap_fieldname = 'ASR_COMMENT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBOE_KOPFDAT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZBOE_KOPFDATSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZBOE_NOTE' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NoteComment' iv_abap_fieldname = 'NOTE_COMMENT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBOE_NOTE'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZBOE_NOTESet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZBOE_POSDAT' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBOE_POSDAT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZBOE_POSDATSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181214103211'.                  "#EC NOTEXT
