class ZCL_ZCB_GELSENWASSER_MPC definition
  public
...
public section.
  ...
  types:
     TS_KOPFDATEN type ZKERK_S_ZAKOPFDAT_ODATA .
  types:
...
CLASS ZCL_ZCB_GELSENWASSER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCB_GELSENWASSER_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20181126100559'.                  "#EC NOTEXT
